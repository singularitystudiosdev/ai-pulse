...
> **Last updated:** 2026-09-22 00:22 UTC · runs every 30 min · 0 secrets, no X API
...
| [CodeMidas: Scaling Agentic Coding RL Environments from Code Itself](https://huggingface.co/papers/2609.22068) | Bowen Ye | 88 HF upvotes · v 88 | 88 HF upvotes · "CodeMidas: Scaling Agentic Coding RL Environments from Code Itself" · model release |
...
| [Show HN: Lossless-memory – a personal AI memory that never summarizes](https://github.com/aru-labs/lossless-memory) | aru-labs | 56 HN points · v 98 | 56 HN points · 21 comments · Show HN |
