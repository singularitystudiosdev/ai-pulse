...
> **Last updated:** 2026-09-22 23:27 UTC · runs every 30 min · 0 secrets, no X API
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Drop – A rootless Linux sandbox with gVisor support](https://droprun.sh/) | mixedbit | 153 HN points · v 257 | 153 HN points · 52 comments · Show HN |
| [Show HN: JevBench, a reproducible benchmark for typed decision models](https://benchmarkheaven.com/jev-models) | florianstandhar | 52 HN points · v 66 | 52 HN points · 7 comments · Show HN |
...
| [Show HN: AI·rete·RAG – a Rete rule engine decides, RAG explains why](https://ai-rete-rag.com/) | ZaharaHussain | 33 HN points · v 37 | 33 HN points · 2 comments · Show HN |
