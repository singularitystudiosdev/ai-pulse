...
> **Last updated:** 2026-09-05 10:26 UTC · runs every 30 min · 0 secrets, no X API
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Open-Source eInk Bike Computer](https://opentrailpaper.com) | stingrae | 289 HN points · v 493 | 289 HN points · 102 comments · Show HN |
| [Show HN: TERMy – A fast terminal assistant that does not use LLMs](https://github.com/gioblu/NPC-Forge/blob/main/docs/development.md) | gioscarab | 136 HN points · v 208 | 136 HN points · 36 comments · Show HN |
