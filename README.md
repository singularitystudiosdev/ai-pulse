...
> **Last updated:** 2026-09-02 11:14 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 268 HF upvotes · v 268 | 268 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
| [Qwen-Drive-1.0: An Initial Step towards a Vision-Language Foundation Model for Autonomous Driving](https://huggingface.co/papers/2609.00111) | Xin Zhou | 98 HF upvotes · v 98 | 98 HF upvotes · "Qwen-Drive-1.0: An Initial Step towards a Vision-Language Foundation M" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Weedout – Safari extension that hides YouTube AI-labeled videos](https://masteranza.github.io/weedout/) | masteranza | 151 HN points · v 283 | 151 HN points · 66 comments · Show HN |
