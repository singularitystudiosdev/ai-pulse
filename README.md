...
> **Last updated:** 2026-09-02 11:30 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 272 HF upvotes · v 272 | 272 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
| [Qwen-Drive-1.0: An Initial Step towards a Vision-Language Foundation Model for Autonomous Driving](https://huggingface.co/papers/2609.00111) | Xin Zhou | 117 HF upvotes · v 117 | 117 HF upvotes · "Qwen-Drive-1.0: An Initial Step towards a Vision-Language Foundation M" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Weedout – Safari extension that hides YouTube AI-labeled videos](https://masteranza.github.io/weedout/) | masteranza | 154 HN points · v 288 | 154 HN points · 67 comments · Show HN |
