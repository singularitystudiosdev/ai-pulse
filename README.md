...
> **Last updated:** 2026-09-02 20:01 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 412 HF upvotes · v 412 | 412 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
| [Alibaba’s Zvec team open-sourced zg, a local search tool for developers and AI agents.  • Local-first • Works…](https://x.com/QwenDevs/status/2095157452904018263) | [@QwenDevs](https://x.com/QwenDevs) | 1364♥ 143RT · v 350 | 350 velocity · 1364♥ 143RT · 76085 views · 6h old · matched "open-sourced" |
