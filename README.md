...
> **Last updated:** 2026-09-23 17:13 UTC · runs every 30 min · 0 secrets, no X API
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Drop – A rootless Linux sandbox with gVisor support](https://droprun.sh/) | mixedbit | 180 HN points · v 300 | 180 HN points · 60 comments · Show HN |
...
| [Show HN: Training a model to identify AI web content from structure alone](https://arxiv.org/abs/2609.15369) | jochenmadler | 62 HN points · v 102 | 62 HN points · 20 comments · Show HN |
