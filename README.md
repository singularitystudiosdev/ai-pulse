...
> **Last updated:** 2026-09-04 20:12 UTC · runs every 30 min · 0 secrets, no X API
...
| [LLaDA-Image: Building Strong Image Generators with Fully Open Training Recipes](https://huggingface.co/papers/2609.03796) | Chuyan Chen | 180 HF upvotes · v 180 | 180 HF upvotes · "LLaDA-Image: Building Strong Image Generators with Fully Open Training" · model release |

### 🚀 AI SaaS launches (4)

| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Open-Source eInk Bike Computer](https://opentrailpaper.com) | stingrae | 136 HN points · v 238 | 136 HN points · 51 comments · Show HN |
| [Show HN: TERMy – A fast terminal assistant that does not use LLMs](https://github.com/gioblu/NPC-Forge/blob/main/docs/development.md) | gioscarab | 48 HN points · v 86 | 48 HN points · 19 comments · Show HN |
