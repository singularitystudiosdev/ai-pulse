...
> **Last updated:** 2026-09-20 19:53 UTC · runs every 30 min · 0 secrets, no X API
...
| [DeepSeek-V4.1-Flash: Pushing the Limits of KV Cache Compression](https://huggingface.co/papers/2609.19969) | DeepSeek-AI | 132 HF upvotes · v 132 | 132 HF upvotes · "DeepSeek-V4.1-Flash: Pushing the Limits of KV Cache Compression" · model release |
...
| [Show HN: Swarm, an offline family tree app for macOS](https://github.com/samoilev/swarm) | samoilev | 5 HN points · v 13 | 5 HN points · 4 comments · Show HN |
