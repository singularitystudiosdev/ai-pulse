...
> **Last updated:** 2026-09-19 09:17 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [LimiX-2: A Contextual Mechanism Network Towards General Structured-Data Intelligence](https://huggingface.co/papers/2609.17488) | Xingxuan Zhang | 264 HF upvotes · v 264 | 264 HF upvotes · "LimiX-2: A Contextual Mechanism Network Towards General Structured-Dat" · model release |
...
| [Can MiniMax-H3 Reason About the Physical World? An Evaluation of Omni-Modal Generative Model](https://huggingface.co/papers/2609.18323) | Haoyu Zhao | 69 HF upvotes · v 69 | 69 HF upvotes · "Can MiniMax-H3 Reason About the Physical World? An Evaluation of Omni-" · model release |
| [When EOS Tokens Disagree: Understanding Length Inflation in On-Policy Distillation](https://huggingface.co/papers/2609.20511) | Yuxiao Yang | 69 HF upvotes · v 69 | 69 HF upvotes · "When EOS Tokens Disagree: Understanding Length Inflation in On-Policy " · model release |
