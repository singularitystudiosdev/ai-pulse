...
> **Last updated:** 2026-09-15 01:41 UTC · runs every 30 min · 0 secrets, no X API
...
| [Benchmark Radar: A Living Database and Search Engine for AI Benchmarks and Evaluation](https://huggingface.co/papers/2609.11115) | Koutian Wu | 111 HF upvotes · v 111 | 111 HF upvotes · "Benchmark Radar: A Living Database and Search Engine for AI Benchmarks" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Nari Qwen3-TTS and Qwen3-ASR – High accuracy, low latency and cost](https://narilabs.com/blog/nari-labs-leads-coval-voice-ai-benchmarks/) | toebee | 67 HN points · v 107 | 67 HN points · 20 comments · Show HN |
