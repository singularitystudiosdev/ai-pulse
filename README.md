...
> **Last updated:** 2026-09-21 20:42 UTC · runs every 30 min · 0 secrets, no X API
...
| [Grounded Skill Synthesis from Code at Scale for Agentic Intelligence](https://huggingface.co/papers/2609.05571) | Yongqi Tong | 86 HF upvotes · v 86 | 86 HF upvotes · "Grounded Skill Synthesis from Code at Scale for Agentic Intelligence" · model release |

### 🚀 AI SaaS launches (4)

| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Mini-AGI – Dynamic continual learning model trained on 8GB VRAM](https://github.com/volotat/mini-AGI/) | volotat | 240 HN points · v 342 | 240 HN points · 51 comments · Show HN |
