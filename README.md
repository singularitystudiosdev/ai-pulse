...
> **Last updated:** 2026-09-04 22:02 UTC · runs every 30 min · 0 secrets, no X API
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Open-Source eInk Bike Computer](https://opentrailpaper.com) | stingrae | 188 HN points · v 308 | 188 HN points · 60 comments · Show HN |
| [Show HN: TERMy – A fast terminal assistant that does not use LLMs](https://github.com/gioblu/NPC-Forge/blob/main/docs/development.md) | gioscarab | 75 HN points · v 125 | 75 HN points · 25 comments · Show HN |
