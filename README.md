...
> **Last updated:** 2026-09-05 13:18 UTC · runs every 30 min · 0 secrets, no X API
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Open-Source eInk Bike Computer](https://opentrailpaper.com) | stingrae | 313 HN points · v 525 | 313 HN points · 106 comments · Show HN |
| [Show HN: TERMy – A fast terminal assistant that does not use LLMs](https://github.com/gioblu/NPC-Forge/blob/main/docs/development.md) | gioscarab | 155 HN points · v 235 | 155 HN points · 40 comments · Show HN |
