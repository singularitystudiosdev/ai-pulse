...
> **Last updated:** 2026-09-22 18:03 UTC · runs every 30 min · 0 secrets, no X API
...
| [WorldCrafter: Consistent Video World Model with Implicit 3D-aware Memory](https://huggingface.co/papers/2609.24984) | Wangbo Yu | 109 HF upvotes · v 109 | 109 HF upvotes · "WorldCrafter: Consistent Video World Model with Implicit 3D-aware Memo" · model release |
...
| [Show HN: Drop – A rootless Linux sandbox with gVisor support](https://droprun.sh/) | mixedbit | 109 HN points · v 183 | 109 HN points · 37 comments · Show HN |
