...
> **Last updated:** 2026-09-02 07:35 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 207 HF upvotes · v 207 | 207 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Weedout – Safari extension that hides YouTube AI-labeled videos](https://masteranza.github.io/weedout/) | masteranza | 118 HN points · v 210 | 118 HN points · 46 comments · Show HN |
