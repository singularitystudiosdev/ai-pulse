...
> **Last updated:** 2026-09-21 10:14 UTC · runs every 30 min · 0 secrets, no X API
...
| [DeepSeek-V4.1-Flash: Pushing the Limits of KV Cache Compression](https://huggingface.co/papers/2609.19969) | DeepSeek-AI | 141 HF upvotes · v 141 | 141 HF upvotes · "DeepSeek-V4.1-Flash: Pushing the Limits of KV Cache Compression" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Mini-AGI – Dynamic continual learning model trained on 8GB VRAM](https://github.com/volotat/mini-AGI/) | volotat | 78 HN points · v 102 | 78 HN points · 12 comments · Show HN |
