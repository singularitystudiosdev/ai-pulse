...
> **Last updated:** 2026-09-02 19:55 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 411 HF upvotes · v 411 | 411 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
