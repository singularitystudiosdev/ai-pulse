...
> **Last updated:** 2026-09-25 17:15 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [Training Object Permanence in World Models](https://huggingface.co/papers/2609.28654) | Haotian Zhang | 153 HF upvotes · v 153 | 153 HF upvotes · "Training Object Permanence in World Models" · model release |
...
| [Your Transformer Can Hold Two Thoughts at Once: Evidence of Linear Superposition in LLMs](https://huggingface.co/papers/2609.29845) | Pavel Tikhonov | 44 HF upvotes · v 44 | 44 HF upvotes · "Your Transformer Can Hold Two Thoughts at Once: Evidence of Linear Sup" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Whiteboard (YC W26) – An open-source IDE for thoughtful software design](https://github.com/devdotfast/whiteboard) | sidharthkmenon | 369 HN points · v 621 | 369 HN points · 126 comments · Show HN |
...
| [Show HN: Agentic CUDA Kernel Optimizer](https://github.com/bertaye/agentic-cuda-optimizer) | bertaye | 29 HN points · v 45 | 29 HN points · 8 comments · Show HN |
| [Show HN: The last day of the dinosaurs, as an interactive painting](https://www.echohive.ai/experiments/dinosaurs) | echohive42 | 17 HN points · v 43 | 17 HN points · 13 comments · Show HN |
