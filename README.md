...
> **Last updated:** 2026-09-04 20:02 UTC · runs every 30 min · 0 secrets, no X API
...
| [LLaDA-Image: Building Strong Image Generators with Fully Open Training Recipes](https://huggingface.co/papers/2609.03796) | Chuyan Chen | 178 HF upvotes · v 178 | 178 HF upvotes · "LLaDA-Image: Building Strong Image Generators with Fully Open Training" · model release |

### 🚀 AI SaaS launches (4)

| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Open-Source eInk Bike Computer](https://opentrailpaper.com) | stingrae | 129 HN points · v 219 | 129 HN points · 45 comments · Show HN |
| [Show HN: TERMy – A fast terminal assistant that does not use LLMs](https://github.com/gioblu/NPC-Forge/blob/main/docs/development.md) | gioscarab | 45 HN points · v 81 | 45 HN points · 18 comments · Show HN |
