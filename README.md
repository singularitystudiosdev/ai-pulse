...
> **Last updated:** 2026-09-02 07:39 UTC · runs every 30 min · 0 secrets, no X API

### 🧠 Model releases (5)

| post | source | signal | why it's here |
|---|---|---|---|
| [StudentSim: Training LLM-based Student Simulators](https://huggingface.co/papers/2609.01591) | Ke Yang | 208 HF upvotes · v 208 | 208 HF upvotes · "StudentSim: Training LLM-based Student Simulators" · model release |
...
| post | source | signal | why it's here |
|---|---|---|---|
| [Show HN: Weedout – Safari extension that hides YouTube AI-labeled videos](https://masteranza.github.io/weedout/) | masteranza | 118 HN points · v 214 | 118 HN points · 48 comments · Show HN |
